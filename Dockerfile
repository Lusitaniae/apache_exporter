...
RUN GO111MODULE=on go build -ldflags "-X github.com/prometheus/common/version.Version=$(git describe --tags --abbrev=0) -X github.com/prometheus/common/version.Revision=$(git rev-parse HEAD)" -o /go/bin/apache_exporter
